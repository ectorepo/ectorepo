...
<manifest>
  ...
  <project name="frrouting/frr" path="frr" revision="refs/heads/main" remote="master"/>
...
<manifest>
  <project name="budimanjojo/vyos-config" path="budimanjojo/vyos-config" revision="refs/heads/main" remote="github"/>
  <project name="huihuimoe/vyos-arm64-build" path="huihuimoe/vyos-arm64-build" revision="refs/heads/master" remote="github"/>
  <project name="yunzheng/vyos-arm64-iso" path="yunzheng/vyos-arm64-iso" revision="refs/heads/main" remote="github"/>
  <project name="mu-ruU1/vyos-build-container-image" path="mu-ruU1/vyos-build-container-image" revision="refs/heads/main" remote="github"/>
