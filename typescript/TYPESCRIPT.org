...
#+begin_src sh :results output file link :file img/ts-deps-starlight-index.svg :var ectoroot=(identity ectoroot)
...
#+attr_html: :style: width:800px;
#+begin_src sh :results output file link :file img/ts-deps-starlight-all.svg :var ectoroot=(identity ectoroot)
cd $ectoroot/typescript/astro/starlight
