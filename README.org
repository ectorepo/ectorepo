...
+ [[https://www.chromium.org/chromium-os/developer-library/guides/development/work-on-branch/#check-out-the-whole-tree-with-repo][ChromiumOS Guide to Working on Branches]]
...
*** Preventing dumb branches with git hooks or repo hooks

LLM had some alright ideas for scripting. most of the pieces were there ... just
completely jumbled up.

#+begin_src shell
# ...
EXPECTED_REF=$(xmllint --xpath "string(//project[@path='$REPO_PROJECT']/@revision)" "$MANIFEST_XML" 2>/dev/null)
# ... if empty
EXPECTED_REF=$(xmllint --xpath "string(//default/@revision)" "$MANIFEST_XML" 2>/dev/null)
# ...
...
+ Checking 100s of repos in =pre-commit= is complicated. shouldn't require too
  much auth, but i haven't though much about it. i try to fix it while i'm
  making changes. i don't expect anyone else to consume the repo's.
+ Doesn't fix =default.xml= manifests that were valid, but no longer are (probably
  need to poll, then fix on a backend... which means also pulling)
+ There are more glitches as well. I think other people just have git remotes,
  whereas i've just had excuses... so it doesn't make sense bc i've never
...

=d/p2
-----END PGP MESSAGE-----
