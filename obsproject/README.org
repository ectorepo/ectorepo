...
<manifest>
  ...
  <include name="obsproject/plugins.xml"/>
</manifest>
#+end_src
...
<manifest>
  <project name="obs-websocket-community-projects/obs-websocket-js" path="wslib/obs-websocket-js" revision="refs/heads/master" remote="github"/>
  <project name="obs-websocket-community-projects/obs-websocket-docker" path="wslib/obs-websocket-docker" revision="refs/heads/main" remote="github"/>
  <project name="obs-websocket-community-projects/obs-websocket-java" path="wslib/obs-websocket-java" revision="refs/heads/develop" remote="github"/>
  <project name="obs-websocket-community-projects/obs-websocket-proxy-client" path="wslib/obs-websocket-proxy-client" revision="refs/heads/master" remote="github"/>
...
<manifest>
  <project name="univrsal/input-overlay" path="plugins/input-overlay" revision="refs/heads/master" remote="github"/>
  <project name="StreamUPTips/obs-streamup-hotkey-display" path="plugins/obs-streamup-hotkey-display" revision="refs/heads/main" remote="github"/>
</manifest>
#+end_src
